...
import Hero from "../../images/team.png";
  ...
  return (
    <div>
      <div className="mx-auto  self-center">
        <img src={HeroBg} alt="" className="absolute ml-[605px]" />
        <div className="container flex mx-auto justify-items-center items-center py-1 px-4 sm:py-4 sm:px-16 md:py-8 md:px-32 bg-white rounded-sm shadow-lg lg:w-[1080px]">
          <div className="w-full">
            <div className="flex">
              <div className="w-full lg:w-3/4 mt-12 mb-12 sm:mb-24 mx-4 bg-[#008783] px-6 py-2 sm:px-12 sm:py-4 rounded-xl">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className=" mt-12 mb-8 flex justify-end w-full">
                    <button
                      type="submit"
                      className="block py-2 px-6 bg-text rounded-full w-full text-lg font-bold text-[#E6E6E6]"
                    >
                      Masuk
                    </button>
                  </div>
              ...
              <div className="hidden lg:flex justify-center items-center -mt-12 -ml-4 border-1 border-black rounded-lg">
                <img src={Hero} alt="HeroImage" className="w-[750px] h-[450px] rounded-lg" />
              </div>
            </div>
          </div>
        </div>
